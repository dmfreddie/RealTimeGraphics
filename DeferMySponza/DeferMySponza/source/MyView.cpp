...
#pragma region Shaders
	...
	//pointLightShader = Shader("Deffered_Point_Light_VS.glsl", "Deffered_Point_Light_FS.glsl");
	gbufferShadr->Bind();
...
#pragma endregion 
	...
	ambientLightShader->Bind();
	//ambientLightShader->SetUniformMatrix4FValue("projection_view", projection_view);
